                ...
                <ul class="list-unstyled mb-0">
                    ...
                    <li class="d-flex justify-content-between py-2 border-bottom">
                        ...
                        <span class="fw-medium">
                            @if($encounter->patient->beneficiary->date_of_birth)
                                {{ \Carbon\Carbon::parse($encounter->patient->beneficiary->date_of_birth)->age }} years
                            @else
                                N/A
                            @endif
                        </span>
                    ...
                    <li class="d-flex justify-content-between py-2 border-bottom">
                        ...
                        <span class="fw-medium">{{ $encounter->patient->beneficiary->phone ?? 'N/A' }}</span>
                    </li>
